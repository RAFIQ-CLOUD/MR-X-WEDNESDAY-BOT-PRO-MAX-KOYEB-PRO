...
from info import ADMINS, LOG_CHANNEL, SUPPORT_CHAT, MELCOW_NEW_USERS, MELCOW_IMG, MELCOW_VID
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            k = await message.reply(
                text='ᴄʜᴀᴛ ɴᴏᴛ ᴀʟʟᴏᴡᴇᴅ 🐞\n\nMʏ ᴀᴅᴍɪɴꜱ ʜᴀꜱ ʀᴇꜱᴛʀɪᴄᴛᴇᴅ ᴍᴇ ғʀᴏᴍ ᴡᴏʀᴋɪɴɢ ʜᴇʀᴇ ! Iғ ʏᴏᴜ ᴡᴀɴᴛ ᴛᴏ ᴋɴᴏᴡ ᴍᴏʀᴇ ᴀʙᴏᴜᴛ ɪᴛ ᴄᴏɴᴛᴀᴄᴛ ꜱᴜᴘᴘᴏʀᴛ.. [@MR_X_MIRROR] for paid work..</b>',
            ...
            return
        buttons = [[
            InlineKeyboardButton('⊹ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ⊹', url=f"https://t.me/MROTTTamilOffl"),
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                temp.MELCOW['welcome'] = await message.reply_video(
                                                 video=(MELCOW_VID),                                               
                                                 caption=f'<b>Hᴇʏ ᴛʜᴇʀᴇ.. {u.mention} 😍\nWᴇʟᴄᴏᴍᴇ ᴛᴏ {message.chat.title} Hᴏᴡ Aʀᴇ Yᴏᴜ?\n\n➠Rᴇϙᴜᴇsᴛ Fᴏʀᴍᴀᴛ\nMᴏᴠɪᴇ Nᴀᴍᴇ (Cᴏʀʀᴇᴄᴛ sᴘᴇʟʟɪɴɢ)\nYᴇᴀʀ Oʀ Lᴀɴɢᴜᴀɢᴇ\n\n➠ Sᴇᴀʀᴄʜ Oɴ Gᴏᴏɢʟᴇ & Pᴀsᴛᴇ Hᴇʀᴇ! Wɪᴛʜ Cᴏʀʀᴇᴄᴛ Pʀᴏᴘᴇʀ Sᴘᴇʟʟɪɴɢ!\nTᴏ Gᴇᴛ Mᴏᴠɪᴇ\n\n➠Exᴀᴍᴘʟᴇ :\nTʜᴜɴɪᴠᴜ (2023) Tᴀᴍɪʟ\nVᴀʀɪsᴜ (2023) Tᴀᴍɪʟ\n\nDᴏɴᴛ Tʏᴘᴇ ( Mᴏᴠɪᴇ, ʙʀᴏ, Aɴᴜᴘᴜɢᴀ, Hᴅ) Yᴏᴜ ᴡᴏɴᴛ Gᴇᴛ Aɴʏᴛʜɪɴɢ!</b>',

                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⊹ ᴍᴀɪɴ ᴄʜᴀɴɴᴇʟ ⊹', url='https://t.me/MROTTTamilXOffl') ],

                                                                                      [ InlineKeyboardButton('〆 ᴍᴏᴠɪᴇ ʀᴇǫᴜᴇsᴛ 〆', url='https://t.me/+fUGYs52Q9vxjZDFh') ]
...
async def leave_a_chat(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=chat,
            text='<b>Hello Friends, \nMy admin has told me to leave from group so i go! If you wanna add me again contact my support contact [@MR_X_MIRROR] for paid work.</b>',
            reply_markup=reply_markup,
        )
...
async def disable_chat(bot, message):
    ...
    try:
        ...
        await bot.send_message(
            chat_id=chat_, 
            text=f'<b>ʜᴇʟʟᴏ ғʀɪᴇɴᴅ, \nMʏ ᴀᴅᴍɪɴ ʜᴀꜱ ᴛᴏʟᴅ ᴍᴇ ᴛᴏ ʟᴇᴀᴠᴇ ғʀᴏᴍ ɢʀᴏᴜᴘ ꜱᴏ ɪ ɢᴏ! Iғ ʏᴏᴜ ᴡᴀɴɴᴀ ᴀᴅᴅ ᴍᴇ ᴀɢᴀɪɴ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ. [@MR_X_MIRROR] for paid work.</b> \nReason : <code>{reason}</code>',
            reply_markup=reply_markup)
